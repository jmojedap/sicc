...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path	= 'resources/assets/grocery_crud/languages';
	protected $default_config_path		= 'resources/assets/grocery_crud/config';
	protected $default_assets_path		= 'resources/assets/grocery_crud';
