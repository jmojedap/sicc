<div id="navbarApp">
    <nav class="navbar fixed-top navbar-expand-lg" style="background-color: #f6f9fd;">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img class="d-block" src="<?= URL_RESOURCES . 'brands/cultured_bogota/' ?>logo-navbar.png" alt="Logo App" style="height: 30px;">
            </a>
