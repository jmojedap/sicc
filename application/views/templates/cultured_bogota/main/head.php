...
<link href="<?= URL_RESOURCES ?>templates/cultured_bogota/toastr.css" rel="stylesheet" type="text/css" />
...
<!-- navbar elements -->
<script src="<?= URL_RESOURCES ?>config/cultured_bogota/menus/nav_1_elements_<?= $this->session->userdata('role') ?>.js"></script>

<link rel="stylesheet" href="<?= URL_RESOURCES ?>templates/cultured_bogota/theme-crb.css">
<link rel="stylesheet" href="<?= URL_RESOURCES ?>templates/cultured_bogota/style.css">
<link rel="stylesheet" href="<?= URL_RESOURCES ?>templates/cultured_bogota/app.css">
<link rel="stylesheet" href="<?= URL_RESOURCES ?>templates/cultured_bogota/mobile.css">