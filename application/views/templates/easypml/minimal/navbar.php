<div class="main-navbar fixed-top d-flex justify-content-between align-items-center">
    <div class="d-flex">
        <a href="<?= URL_APP ?>observatorio/inicio">
            <img src="<?= URL_BRAND ?>logo-navbar.png" alt="Logo App" title="Inicio" class="app-logo">
        </a>
    ...
    <div>
        <div class="only-lg">
            ...
            <?php else: ?>
                <div class="">
                    <a class="main-navbar-link" href="<?= URL_APP ?>accounts/login_link" role="button">
                        Ingresar
                    </a>
                </div>
            <?php endif; ?>
