...
<div id="clasificarApp">
    <div class="center_box_750">
        ...
        <div v-show="section == 'clasificar'">
            <?php $this->load->view('app/noticias/clasificar/formulario_v') ?>
        </div>
        <div v-show="section == 'ayuda'">
            <?php $this->load->view('app/noticias/clasificar/ayuda_v') ?>
        </div>
...
<?php $this->load->view('app/noticias/clasificar/vue_v') ?>