...
contenido.metodologia_cod = '<?= $row->metodologia_cod ?>';
contenido.tipo_archivo = '<?= $row->tipo_archivo ?>';
...
var editContenidoApp = createApp({
    data(){
        return{
            ...
            arrEtapa: <?= json_encode($arrEtapa) ?>,
            arrPeriodicidad: <?= json_encode($arrPeriodicidad) ?>,
            arrMedioDivulgacion: <?= json_encode($arrMedioDivulgacion) ?>,
