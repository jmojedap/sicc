...
var parametrosApp = createApp({
    data(){
        return{
            ...
            scopes: [
                ...
                {id:'barrios-vivos', name: 'Barrios Vivos'},
    ...
    methods: {
        ...
        getList: function (){
            axios.get(URL_APP + 'parametros/get_list/' + this.currCategory.cod)
            .then(response => {
                this.list = response.data
                history.pushState(null, null, URL_APP + 'parametros/valores/' + this.currCategory.cod + '/' + this.filters.fe2);
            })
            .catch(function (error) { console.log(error) })
        },
