        ...
        <form accept-charset="utf-8" method="POST" id="registroUsuarioForm" @submit.prevent="handleSubmit">
            ...
            <fieldset v-bind:disabled="loading">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-8">
                        <select name="text_3" v-model="fields.text_3" class="form-select form-control" required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-8">
                        <select name="job_role" v-model="fields.job_role" class="form-select form-control" required>
                ...
                <div class="mb-3 row">
                    <label for="text_1" class="col-md-4 col-form-label text-end">Localidad</label>
                    <div class="col-md-8">
                        <select name="text_1" v-model="fields.text_1" class="form-select form-control" required>
                            <option v-for="optionLocalidad in arrLocalidades" v-bind:value="optionLocalidad.name">{{ optionLocalidad.name }}</option>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-8">
                        <input
                            name="address" type="text" class="form-control" minlength="5"
                            required
