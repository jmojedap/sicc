<div class="center_box_920" v-show="section == 'territorios'">
    <div class="mb-2 text-end">
        ...
        <button class="btn btn-light me-2" v-on:click="getDescripcionPriorizacion"
            ...
            <img src="<?= URL_IMG ?>icons/ia-generate.png" alt="Icono generar contenido" style="width: 20px;"> Generar
            descripción
        </button>
    ...
    <table class="table bg-white">
        <thead>
            ...
            <th>Localidad</th>
            <th>Sector</th>
            <th>Puntaje <i class="fas fa-info-circle text-muted"
