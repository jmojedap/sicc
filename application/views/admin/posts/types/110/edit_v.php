...
<?php
    $options_cat_3 = $this->Item_model->arr_options('category_id = 34');
?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="cat_1" v-model="formValues.cat_1" class="form-control" required v-on:change="get_options_cat_2">
                    ...
                    <div class="mb-3">
                        <label for="cat_3">Archivo tipo</label>
                        <select name="cat_3" v-model="formValues.cat_3" class="form-control" required>
                            <option v-for="option_cat_3 in options_cat_3" v-bind:value="option_cat_3.cod">{{ option_cat_3.name }}</option>
                        </select>
                    </div>
                    <div class="mb-3">
...
var editPost = new Vue({
    ...
    data: {
        ...
        options_cat_3: <?= json_encode($options_cat_3) ?>,
    },
    methods: {
        send_form: function(){
            this.loading = true
