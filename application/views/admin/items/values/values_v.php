<script src="<?= URL_RESOURCES ?>config/items/items-scopes.js"> </script>

<div id="itemsValuesApp">
    <div class="row">
        <div class="col-md-4">
            <div class="row mb-3">
            ...
            <table class="table bg-white table-sm">
                ...
                <tbody>
                    ...
                    <tr v-for="(category, key) in categories"
                        ...
                        <td class="text-center"><small class="text-muted">{{ category.cod }}</small></td>
        ...
        <div class="col col-md-8">
            <div class="mb-2">
                <a class="btn btn-light me-1" v-bind:href="`<?= URL_ADMIN ?>items/export/`">
    ...
    <?php $this->load->view($this->views_folder . 'values/details_v'); ?>
    <?php $this->load->view($this->views_folder . 'values/modal_form_v'); ?>
    <?php $this->load->view('common/bs5/modal_delete_set_v'); ?>
</div>

<?php $this->load->view($this->views_folder . 'values/vue_v'); ?>