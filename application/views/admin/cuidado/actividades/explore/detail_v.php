    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detail_modal_label">{{ element.nombre_actividad }}</h5>
            ...
            <div class="modal-body">
                <table class="table table-borderless table-sm">
                    ...
                    <tr>
                        <td>Contacto en el espacio</td>
                        <td>
                            {{ element.contacto_espacio }}
                        </td>
                    </tr>
                </table>
            </div>
            <div class="modal-footer">
                    <a class="btn btn-primary w100p" v-bind:href="`<?= URL_ADMIN . 'cuidado/details/' ?>` + element.id">Abrir</a>
