...
if ( withLocation == true ) {
    ...
    //startPoint = [actividad.longitud,actividad.latitud];
    startZoom = 10.2;
    //markerColor = '#ee3248';
}
...
var locationApp = new Vue({
    ...
    methods: {
        ...
        searchLocation: function(){
            ...
            axios.get('https://nominatim.openstreetmap.org/search?q='+ qSearch +'&format=geojson&polygon_geojson=1&addressdetails=1')
            .then(response => {
        ...
        setCurrentPlace: function(placeKey){
            ...
            var point = [this.currentPlace.bbox[0],this.currentPlace.bbox[1]]
            this.addMarker()
