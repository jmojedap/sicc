...
<form accept-charset="utf-8" method="POST" id="search_form" @submit.prevent="get_list">
    ...
    <div id="adv_filters" style="<?= $filters_style ?>" class="mb-2">
        <div class="mb-3 row">
            <div class="col-md-8">
                <select name="role" v-model="filters.role" class="form-select" title="Filtrar por rol">
        ...
        <div class="mb-3 row">
            <div class="col-md-8 text-right">
                <button class="btn btn-light w120p" v-on:click="removeFilters" type="button" v-show="active_filters">Todos</button>
