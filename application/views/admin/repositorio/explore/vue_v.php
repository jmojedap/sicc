...
// Filters
//-----------------------------------------------------------------------------
function tipoName(value, field = 'name'){
    var tipoName = ''
    if (!value) tipoName = '-'
    var item = arrTipo.find(row => row.cod == value)
...
var appExplore = new Vue({
    ...
    methods: {
        ...
        formatoName: function(value = '', field = 'name'){
            var formatoName = ''
            var item = arrFormato.find(row => row.cod == value)
        ...
        classEstadoPublicacion: function(value){
            if (value == 1) return 'badge-success'
            if (value == 10) return 'badge-danger'
