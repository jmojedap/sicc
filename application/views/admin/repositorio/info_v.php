    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-2">
                <div class="card-body">
                    <div class="mb-2">
                        <a href="<?= URL_ADMIN . "repositorio/explore/?repo_tema={$row->tema_cod}" ?>">
                            <?= $this->Item_model->name(415, $row->tema_cod); ?>
                        </a>
                        <i class="fa fa-chevron-right"></i>
                        <a href="<?= URL_ADMIN . "repositorio/explore/?repo_subtema={$row->subtema_1}" ?>">
                            <?= $this->Item_model->name(416, $row->subtema_1); ?>
                        </a>
                    </div>
                    <div class="d-flex">
                        <div class="w240p mr-2">
                            <a href="<?= URL_ADMIN . "repositorio/read/{$row->id}/{$row->slug}" ?>">
                                <img
