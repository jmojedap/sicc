<div id="editContenidoApp">
    <form accept-charset="utf-8" method="POST" id="contenidoForm" @submit.prevent="handleSubmit">
        ...
        <fieldset v-bind:disabled="loading">
            <div class="mb-2">
                <button class="btn btn-lg btn-primary w120p" type="submit">Guardar</button>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tipo_archivo" v-model="fields.tipo_archivo" class="form-select form-control">
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 row">
                                <label for="estado_publicacion" class="col-md-4 col-form-label text-right">Estado publicación</label>
                                <div class="col-md-8">
                                    <select name="estado_publicacion" v-model="fields.estado_publicacion" class="form-select form-control" required>
                            ...
                            <div class="mb-3 row">
                                <label for="puntaje_interno" class="col-md-4 col-form-label text-right">Puntaje interno ({{ fields.puntaje_interno }})</label>
                                <div class="col-md-8">
                                    <input
                                        name="puntaje_interno" type="range" class="w100pc" min="1" max="1000"
                                        title="Puntaje interno" placeholder="Puntaje interno"
                                        v-model="fields.puntaje_interno"
                                    >
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                <label for="subtema_2" class="col-md-4 col-form-label text-right">Subtema 2</label>
                                <div class="col-md-8">
                                    <select name="subtema_2" v-model="fields.subtema_2" class="form-select form-control">
                            ...
                            <div class="mb-3 row">
                                <label for="tipo_contenido" class="col-md-4 col-form-label text-right">Tipo contenido</label>
                                <div class="col-md-8">
                            ...
                            <div class="mb-3 row">
                                <label for="categoria_contenido" class="col-md-4 col-form-label text-right">Categoría</label>
                                <div class="col-md-8">
                            ...
                            <div class="mb-3 row">
                                <label for="metodologia_cod" class="col-md-4 col-form-label text-right">Metodología</label>
                                <div class="col-md-8">
...
<?php $this->load->view('admin/repositorio/edit/basic_vue_v') ?>